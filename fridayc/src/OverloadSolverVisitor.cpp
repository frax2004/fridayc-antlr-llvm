...
namespace friday::inline api::inline pipeline {
  ...
  auto OverloadSolverVisitor::visitFreeFunctionStatement(FridayParser::FreeFunctionStatementContext *ctx) -> any {
    ...
    Overload* asOverload = ctx->overloadDecl.lock();
    ...
    Function* function = make_shared<Function>(*asOverload, *retType, parameters);
    asOverload->add(function);

    Scope* scope = make_shared<Scope>(*asOverload->get_declaring_symbol_table());
