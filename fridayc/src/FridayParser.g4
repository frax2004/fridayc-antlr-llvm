...
/// STATEMENTS
  ...
  ///
  //////////////////////////////
  translationUnit returns [GrammarAttributes* attributes]
  : topLevelStatement*? EOF
  ;

  topLevelStatement returns [GrammarAttributes* attributes]
  : usingStatement
  | namespaceStatement
  | structStatement
  | functionStatement
  ...
  ///
  //////////////////////////////
  namespaceStatement returns [GrammarAttributes* attributes]
  ...
  functionStatement returns [GrammarAttributes* attributes]
  ...
  structStatement returns [GrammarAttributes* attributes]
  ...
  ///
  //////////////////////////////
  statement returns [GrammarAttributes* attributes]
  ...
  ///
  //////////////////////////////
  syntacticalScope returns [GrammarAttributes* attributes]
  : LEFT_CURLY (statement*) RIGHT_CURLY
  ;

  functionScope returns [GrammarAttributes* attributes]
...
///////////////////////////////////////////////////
/// EXPRESSIONS
expression returns [GrammarAttributes* attributes]
...
type returns [GrammarAttributes* attributes]
