...
namespace friday::inline api::inline pipeline {
  ...
  auto TranslationUnit::parse(CompilationContext& ctx, string path) -> TranslationUnit* {
  ...
  auto TranslationUnit::look_up_if(string_view name, ISymbolTable* current, Predicate<ISymbol*> predicate, ISymbol* defaultValue) -> ISymbol* {
    if(current == nullptr) return defaultValue;
  ...
  auto TranslationUnit::get_llvm_module() const -> Pointer<llvm::Module> {
    return this->module;
  }
