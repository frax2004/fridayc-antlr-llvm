...
namespace friday::inline api::inline pipeline {
  ...
  auto BinaryOperatorBuilder::left(Type* type) -> BinaryOperatorBuilder& {
    this->M_lhs = type;
    return *this;
  }

  auto BinaryOperatorBuilder::right(Type* type) -> BinaryOperatorBuilder& {
    this->M_rhs = type;
    return *this;
  }

  auto BinaryOperatorBuilder::returns(Type* type) -> BinaryOperatorBuilder& {
    this->M_ret = type;
    return *this;
  }

  auto BinaryOperatorBuilder::build() -> Overload* {
